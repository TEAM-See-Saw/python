...
# [1] 설정 (경로 수정 필수!)
# ==========================================
LIDAR_PATH = 'dataset_log/20260207_155518/lidar.csv'       # 라이다 파일 경로
IMG_FOLDER = 'dataset_log/20260207_155518/cam0' # 이미지가 저장된 폴더 경로 (수정하세요!)

# 라이다 뷰어 설정
WINDOW_SIZE = 1500   # 라이다 지도 크기 (500x500 픽셀)
