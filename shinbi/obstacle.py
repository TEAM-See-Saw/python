...
# (사용자 환경에 맞게 common_lane_base.py가 있어야 합니다)
...
# 장애물 감지 거리 (mm)
DIST_TRIGGER_1 = 1200  # 첫 번째 장애물(우측에 위치) 감지 거리
DIST_TRIGGER_2 = 1000  # 두 번째 장애물(좌측에 위치) 감지 거리

# 측면 통과 확인 거리 (mm)
# 이 거리보다 멀어지면 "장애물을 완전히 지났다"고 판단
SIDE_CLEAR_THRESHOLD = 600 

# 라이다 각도 설정 (Lidar가 정방향 0도라고 가정)
ANGLE_FRONT_RANGE = 30     # 전방 ±30도 (330~30)
